  ...
  for (let index = 0; index < 4; index++) {
    ...
    if (
      ...
      for (
        let index = 0;
        index <
        document.getElementsByName("equipmentOptions_checkboxes").length;
        index++
      ) {
...
function runOperation_Tab3() {
  ...
  for (let index = 1; index <= 10; index++) {
    if (
      document.getElementById("spectrum_" + index + "_premium_Price")
        .innerHTML != ""
    ) {
      total_3 += numeral(
        document.getElementById("spectrum_" + index + "_premium_Price")
  ...
  total_3 +=
    ...
    numeral(
      document.getElementById("spectrum_dvrbox_4_Price").innerHTML
    ).value();
  // if (
  //   numeral(
  //     document.getElementById('comcast_equipment_Price').innerHTML
...
function runOperation_Tab4() {
  ...
  for (let index = 1; index <= 5; index++) {
    if (
      document.getElementById("metronet_" + index + "_premium_Price")
        .innerHTML != ""
    ) {
      total_3 += numeral(
        document.getElementById("metronet_" + index + "_premium_Price")
  ...
  // 2nd Row
  let modemRental_variable = document.getElementsByName(
...
function runOperation_Tab6() {
  ...
  for (let index = 1; index <= 9; index++) {
    if (
      document.getElementById("directv_" + index + "_premium_Price")
        .innerHTML != ""
    ) {
      total_3 += numeral(
...
function runOperation_Tab7() {
  ...
  for (let index = 1; index <= numeral(tv_variable_2).value(); index++) {
    ...
    document.getElementById(
      "i3_Broadband_tvbox_" + index + "_Price"
    ).innerHTML = i3_Broadband_TV_s_Price[index - 1];
  }
  ...
  if (slider17.val() == "0mbps") {
    document.getElementById("i3_Broadband_fiber_Text").innerHTML =
      slider17.val();
  ...
  for (
    let index = 0;
    index < i3_Broadband_InstallationOptions.length;
    index++
  ) {
...
function runOperation_Tab8() {
  ...
  for (
    let index = 0;
    index < wow_AdditionalServiceInformation.length;
    index++
  ) {
...
function runOperation_Tab9() {
  ...
  for (let index = 0; index < 3; index++) {
    ...
    if (
      ...
      for (
        ...
        document.getElementsByName("mediacom_MultiRoomDVR")[
          index
        ].disabled = true;
      }
  ...
  for (
    ...
    if (
      document.getElementById("mediacom_" + index + "_premium_Price")
        .innerHTML != ""
    ) {
...
function runOperation_Tab12() {
  ...
  for (let index = 0; index < 2; index++) {
    ...
    if (
      ...
      for (
        let index = 0;
        index <
        document.getElementsByName("rcn_PremiumChannels_checkboxes").length;
        index++
      ) {
  ...
  for (let index = 0; index < checkboxes_variable.length; index++) {
    if (checkboxes_variable[index].checked == true) {
      ...
      document.getElementById(
        "rcn_" + (index + 1) + "_premium_Price"
      ).innerHTML = rcn_PremiumChannels[index];
    } else {
  ...
  if (
    numeral(document.getElementById("rcn_fiber_Price").innerHTML).value() !=
    null
  ) {
  ...
  for (
    let index = 0;
    index < rcn_AdditionalServiceInformation.length;
    index++
  ) {
