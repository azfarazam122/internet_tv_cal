...
function runOperation_Tab2() {
	...
	for (let index = 0; index < 3; index++) {
		...
		if (
			...
			document.getElementById("comcast_7_premium_Price").innerHTML = "$0";
			document.getElementById("comcast_8_premium_Price").innerHTML = "$0";
			document.getElementById("comcast_9_premium_Price").innerHTML = "$0";
			document.getElementById("comcast_10_premium_Price").innerHTML = "$0";
			document.getElementById("comcast_11_premium_Price").innerHTML = "$0";
			document.getElementById("comcast_12_premium_Price").innerHTML = "$0";
	...
	if (
		...
		chooseBundlePrice = comcast_BundlePrice_No_TV;
	}
...
function runOperation_Tab13() {
	...
	if (
		...
		chooseBundlePrice = at_t_dtv_BundlePrice_Basic_TV;
	} else if (
		document.getElementsByName("at_t_dtv_channelLineup_checkboxes")[1].checked
	) {
		chooseBundlePrice = at_t_dtv_BundlePrice_Extra_TV;
	} else if (
		document.getElementsByName("at_t_dtv_channelLineup_checkboxes")[2].checked
	) {
		chooseBundlePrice = at_t_dtv_BundlePrice_Preferred_TV;
	} else if (
...
// _________________________________________________________________________
// DISPLAT IFRAME _ 1
var indexForIframe_1 = 1;
function openIframe_1() {
	if (indexForIframe_1 == undefined) {
		document.getElementById("compare_1").style.background = "#0b93d7";
		document.getElementById("compare_1").style.color = "white";
		$("#iframeForComparing_1").show();
		document.getElementById("iframe_1").src = "page.php";
		indexForIframe_1 = 1;
	} else {
		document.getElementById("compare_1").style.background = "white";
		document.getElementById("compare_1").style.color = "black";
		$("#iframeForComparing_1").hide();
		document.getElementById("iframe_1").src = "";
		indexForIframe_1 = undefined;
	}
}
// DISPLAT IFRAME _ 2
var indexForIframe_2 = 1;
function openIframe_2() {
	if (indexForIframe_2 == undefined) {
		document.getElementById("compare_2").style.background = "#0b93d7";
		document.getElementById("compare_2").style.color = "white";
		$("#iframeForComparing_2").show();
		document.getElementById("iframe_2").src = "page.php";
		indexForIframe_2 = 1;
	} else {
		document.getElementById("compare_2").style.background = "white";
		document.getElementById("compare_2").style.color = "black";
		$("#iframeForComparing_2").hide();
		document.getElementById("iframe_2").src = "";
		indexForIframe_2 = undefined;
	}
}
// _________________________________________________________________________
