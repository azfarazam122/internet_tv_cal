		...
		"[iFrameResizerChild]Ready" === g
			...
			? ((m = g.substr(y).split(":")),
			  ...
			  !r &&
					((o = !0),
					F[(t = w)] ||
						((o = !1), O(h.type + " No settings for " + t + ". Message was: " + g)),
					o) &&
					(k(w, "Received: " + g),
					(i = !0),
					null === h.iframe && (O(w, "IFrame (" + h.id + ") not found"), (i = !1)),
					i &&
						(function () {
							var e,
								i = n.origin,
								...
								!(t.constructor === Array
									? (function () {
											var e = 0,
												n = !1;
											for (
												k(w, "Checking connection is from allowed list of origins: " + t);
												e < t.length;
												e++
											)
												if (t[e] === i) {
						...
						(function () {
							switch (
								(F[w] && F[w].firstRun && F[w] && (F[w].firstRun = !1), h.type)
							) {
								case "close":
									F[w].closeRequeston
								...
								case "message":
									(r = s(6)),
										k(
											w,
											"onMessage passed: {iframe: " + h.iframe.id + ", message: " + r + "}"
										),
										l("onMessage", { iframe: h.iframe, message: JSON.parse(r) }),
										k(w, "--");
									break;
								case "scrollTo":
									u(!1);
									...
									(e = s(9)),
										...
										(o = document.getElementById(t) || document.getElementsByName(t)[0])
											? ((n = c(o)),
											  k(
													w,
													"Moving to in page link (#" + i + ") at x: " + n.x + " y: " + n.y
											  ),
											  (v = { x: n.x, y: n.y }),
											  f(),
											  k(w, "--"))
		...
		function t(e) {
			n ||
				...
				(function () {
					...
					function e(e) {
						k("window", "Mutation observed: " + e[0].target + " " + e[0].type),
							c(n, 16);
					}
					var i = w();
					i &&
			...
			: ((d = (d = e) || {}),
			  ...
			  (function (e) {
					for (var n in h)
						Object.prototype.hasOwnProperty.call(h, n) &&
							(F[u][n] = Object.prototype.hasOwnProperty.call(e, n) ? e[n] : h[n]);
			  })(d),
			  F[u] &&
					(F[u].targetOrigin =
						!0 === F[u].checkOrigin
			  ...
			  (function () {
					switch (
						...
						(i.style.overflow = !1 === (F[u] && F[u].scrolling) ? "hidden" : "auto"),
						F[u] && F[u].scrolling)
					) {
						case "omit":
							break;
